  ...
  workouts: {
    ...
    "Pull A": [
      ...
      },
      {
        ...
        sets: "3 sets",
        category: "Shoulder",
        note: "🎯 EXERCISE 5. REAR DELT MASS. Superior to face pulls for pure hypertrophy. Eliminates momentum and forces maximum mechanical tension into the posterior deltoid.",
        tips: [
          "Adjust seat height so the handles are exactly level with your shoulders.",
          "Keep arms slightly bent but rigid; do not bend and press the weight.",
          "Drive the weight back by pulling your shoulder blades together.",
          "Control the negative. Do not let the weight plates slam.",
        ],
        image: [
    ...
    "Pull B (Width + Arms + Forearms)": [
      ...
      },
      {
        ...
        sets: "3 sets",
        category: "Back",
        note: "🎯 EXERCISE 2. BACK DENSITY. The wide grip forces the rhomboids and rear delts to do the heavy lifting.",
        tips: [
          "✅ Wide Grip: Use the outermost horizontal handles.",
          "✅ Support: If using a machine, keep chest glued to the pad.",
          "✅ Flare Elbows: Pull toward upper stomach, flaring elbows out.",
          "✅ Scapular Squeeze: Squeeze shoulder blades together at the top.",
          "❌ No Momentum: Do not bounce your knees or swing your torso.",
        ],
        image: [
        ...
        video: [
          "https://www.youtube.com/embed/ZbOUxXRS42s",
          "https://www.youtube.com/embed/8pR3JoZ0iBU",
        ],
      ...
      },
      {
        ...
        sets: "3 sets",
        category: "Back",
        note: "📐 EXERCISE 3. THE WIDE SWEEP. Using the outermost grip on the long bar to force the lats to flare.",
        tips: [
          ...
          "3-second slow release to maximize the stretch.",
        ],
        image: [
          "https://fitnessprogramer.com/wp-content/uploads/2021/02/Lat-Pulldown.gif",
        ],
        video: ["https://www.youtube.com/embed/HWGntttgJQw"],
        impact: ["Outer Lat Flare", "V-Taper Width"],
      },
      {
        id: "bi-2",
        ...
        sets: "3 sets",
        category: "Biceps",
        note: "⚙️ EXERCISE 4. S-TIER ISOLATION. Paralyzes the shoulder joint for pure bicep tension.",
        tips: [
          "Jam armpits tightly over the top of the pad.",
          "Keep triceps glued to the pad throughout the rep.",
          "Strict 3-second negative phase.",
        ],
        image: [
          "https://fitnessprogramer.com/wp-content/uploads/2021/04/Lever-Preacher-Curl.gif",
        ],
        video: ["https://www.youtube.com/embed/P13VQDU1q9c"],
        impact: ["Bicep Short Head", "Zero Momentum Isolation"],
      },
      {
        id: "bi-3",
      ...
      },
      {
        ...
        sets: "3 sets",
        category: "Forearm",
        note: "🔥 EXERCISE 6. FOREARM FLEXORS. Constant tension for thick, vascular forearms.",
        tips: [
