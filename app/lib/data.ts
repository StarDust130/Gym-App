  ...
  workouts: {
    ...
    "Pull B (Width + Arms + Forearms)": [
      ...
      },
      {
        ...
        sets: "3 sets",
        category: "Biceps",
        note: "🏔️ EXERCISE 4. PURE ISOLATION. Lock your armpits into the pad. Zero momentum. Control the negative.",
        tips: [
          "Drive your triceps flat into the pad; do not let them lift off",
          "Lower the bar fully for a 3-second negative until arms are nearly straight",
          "Do not let your shoulders roll forward over the pad",
          "Explode up and squeeze, but do not rest the weight at the top",
        ],
        image: [
          "https://fitnessprogramer.com/wp-content/uploads/2021/02/Z-Bar-Preacher-Curl.gif",
        ],
        video: ["https://youtube.com/embed/7ixqAPO6JvU?si=1zrRM-O2ZtMoup5T"],
        impact: ["Overall Bicep Mass", "Strict Isolation (Zero Cheating)"],
      },
      {
        id: "bi-3",
        name: "Hammer Curl",
